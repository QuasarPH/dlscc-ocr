import { DocumentCategory, LoanApplicationData, UnsecuredLoansApplicationData, SpecialLoansData, TableColumn } from './types';
...
export const CATEGORY_COLORS: Record<DocumentCategory, string> = {
  [DocumentCategory.LOAN_APPLICATION]: "bg-blue-600 hover:bg-blue-700 text-white",
  [DocumentCategory.UNSECURED_LOANS_APPLICATION]: "bg-teal-600 hover:bg-teal-700 text-white",
  [DocumentCategory.SPECIAL_LOANS]: "bg-purple-600 hover:bg-purple-700 text-white",
  [DocumentCategory.OTHERS]: "bg-gray-500 hover:bg-gray-600 text-white",
  [DocumentCategory.PROCESSING]: "bg-amber-500 text-black", // Ensure good contrast for amber
  [DocumentCategory.ERROR]: "bg-red-600 hover:bg-red-700 text-white",
};
...
export const COLUMN_DEFINITIONS: Record<DocumentCategory, TableColumn<any>[]> = {
