...
export interface UnsecuredLoansApplicationData {
...
export interface SpecialLoansData {
...
export type ExtractedData = LoanApplicationData | UnsecuredLoansApplicationData | SpecialLoansData;
...
export interface TableColumn<T extends ExtractedData> {
  key: keyof T;
  label: string;
